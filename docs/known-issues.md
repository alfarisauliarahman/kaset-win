...
| **Antrean mini player basi setelah antrean habis** | Resync eksplisit saat masuk mini TIDAK menyembuhkan (putaran 16) — berarti VM mini sudah memegang datanya dan divergensinya di tempat lain. Jejak `mini-queue open: history/upnext/now/tracks` sudah dipasang; butuh satu reproduksi dengan jejak itu sebelum perbaikan berikutnya. |
