...
public interface ILoginFlow
{
    ...
    /// closes — either automatically after a valid session is detected or because the user
    /// cancelled.
    /// </summary>
...
internal sealed class LoginFlow : ILoginFlow
{
    ...
    public async Task<bool> ShowAsync(XamlRoot xamlRoot)
    {
        ...
        // Req 4.2: begin login — the service moves to LoggingIn and the dialog presents the flow.
